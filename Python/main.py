...
class Board_sprite():
    def __init__(self, board_size: int, board_texture_path: str = ''):
...
class Chess_board():
    def __init__(self):
        ...
        self.load_chess_set()
        self.board_sprite = Board_sprite(self.board_size)
    ...
    def load_chess_set(self) -> None:
        ...
        path_to_pieces = '1x/'
        self.piece_bishop_black = Piece_sprite(path_to_pieces + 'b_bishop_1x.png', pice_size_for_set)
        self.piece_bishop_white = Piece_sprite(path_to_pieces + 'w_bishop_1x.png', pice_size_for_set)
        self.piece_king_black = Piece_sprite(path_to_pieces + 'b_king_1x.png', pice_size_for_set)
        self.piece_king_white = Piece_sprite(path_to_pieces + 'w_king_1x.png', pice_size_for_set)
        self.piece_knight_black = Piece_sprite(path_to_pieces + 'b_knight_1x.png', pice_size_for_set)
        self.piece_knight_white = Piece_sprite(path_to_pieces + 'w_knight_1x.png', pice_size_for_set)
        self.piece_pawn_black = Piece_sprite(path_to_pieces + 'b_pawn_1x.png', pice_size_for_set - 10)
        self.piece_pawn_white = Piece_sprite(path_to_pieces + 'w_pawn_1x.png', pice_size_for_set - 10)
        self.piece_queen_black = Piece_sprite(path_to_pieces + 'b_queen_1x.png', pice_size_for_set)
        self.piece_queen_white = Piece_sprite(path_to_pieces + 'w_queen_1x.png', pice_size_for_set)
        self.piece_rook_black = Piece_sprite(path_to_pieces + 'b_rook_1x.png', pice_size_for_set)
        self.piece_rook_white = Piece_sprite(path_to_pieces + 'w_rook_1x.png', pice_size_for_set)
    ...
    def draw_piece_on(self, surface: pygame.surface.Surface, piece: Piece_sprite, tile_x: int, tile_y: int) -> None:
        rect = piece.rect
...
while 1:
    ...
    if not game_over and not human_move_frame:
        if chess_board.chess_logic.turn == ai_player_1:
            move, eval = model.run_min_max(chess_board.chess_logic)
