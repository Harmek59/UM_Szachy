//https://github.com/pjpuzzler/cpp-chess
/*
...
namespace chess
{
    ...
    const Bitboard BB_SQUARES[] = {
        ...
        Bitboard(1) << 63,
                   ...
                   BB_A1 = Bitboard(1) << 0, BB_B1 = Bitboard(1) << 1, BB_C1 = Bitboard(1) << 2, BB_D1 = Bitboard(1) << 3, BB_E1 = Bitboard(1) << 4, BB_F1 = Bitboard(1) << 5, BB_G1 = Bitboard(1) << 6, BB_H1 = Bitboard(1) << 7, BB_A2 = Bitboard(1) << 8, BB_B2 = Bitboard(1) << 9, BB_C2 = Bitboard(1) << 10, BB_D2 = Bitboard(1) << 11, BB_E2 = Bitboard(1) << 12, BB_F2 = Bitboard(1) << 13, BB_G2 = Bitboard(1) << 14, BB_H2 = Bitboard(1) << 15, BB_A3 = Bitboard(1) << 16, BB_B3 = Bitboard(1) << 17, BB_C3 = Bitboard(1) << 18, BB_D3 = Bitboard(1) << 19, BB_E3 = Bitboard(1) << 20, BB_F3 = Bitboard(1) << 21, BB_G3 = Bitboard(1) << 22, BB_H3 = Bitboard(1) << 23, BB_A4 = Bitboard(1) << 24, BB_B4 = Bitboard(1) << 25, BB_C4 = Bitboard(1) << 26, BB_D4 = Bitboard(1) << 27, BB_E4 = Bitboard(1) << 28, BB_F4 = Bitboard(1) << 29, BB_G4 = Bitboard(1) << 30, BB_H4 = Bitboard(1) << 31, BB_A5 = Bitboard(1) << 32, BB_B5 = Bitboard(1) << 33, BB_C5 = Bitboard(1) << 34, BB_D5 = Bitboard(1) << 35, BB_E5 = Bitboard(1) << 36, BB_F5 = Bitboard(1) << 37, BB_G5 = Bitboard(1) << 38, BB_H5 = Bitboard(1) << 39, BB_A6 = Bitboard(1) << 40, BB_B6 = Bitboard(1) << 41, BB_C6 = Bitboard(1) << 42, BB_D6 = Bitboard(1) << 43, BB_E6 = Bitboard(1) << 44, BB_F6 = Bitboard(1) << 45, BB_G6 = Bitboard(1) << 46, BB_H6 = Bitboard(1) << 47, BB_A7 = Bitboard(1) << 48, BB_B7 = Bitboard(1) << 49, BB_C7 = Bitboard(1) << 50, BB_D7 = Bitboard(1) << 51, BB_E7 = Bitboard(1) << 52, BB_F7 = Bitboard(1) << 53, BB_G7 = Bitboard(1) << 54, BB_H7 = Bitboard(1) << 55, BB_A8 = Bitboard(1) << 56, BB_B8 = Bitboard(1) << 57, BB_C8 = Bitboard(1) << 58, BB_D8 = Bitboard(1) << 59, BB_E8 = Bitboard(1) << 60, BB_F8 = Bitboard(1) << 61, BB_G8 = Bitboard(1) << 62, BB_H8 = Bitboard(1) << 63;
    ...
    const Bitboard BB_FILES[] = {
        Bitboard(0x0101'0101'0101'0101) << 0,
        Bitboard(0x0101'0101'0101'0101) << 1,
        Bitboard(0x0101'0101'0101'0101) << 2,
        Bitboard(0x0101'0101'0101'0101) << 3,
        Bitboard(0x0101'0101'0101'0101) << 4,
        Bitboard(0x0101'0101'0101'0101) << 5,
        Bitboard(0x0101'0101'0101'0101) << 6,
        Bitboard(0x0101'0101'0101'0101) << 7,
    },
                   BB_FILE_A = Bitboard(0x0101'0101'0101'0101) << 0, BB_FILE_B = Bitboard(0x0101'0101'0101'0101) << 1, BB_FILE_C = Bitboard(0x0101'0101'0101'0101) << 2, BB_FILE_D = Bitboard(0x0101'0101'0101'0101) << 3, BB_FILE_E = Bitboard(0x0101'0101'0101'0101) << 4, BB_FILE_F = Bitboard(0x0101'0101'0101'0101) << 5, BB_FILE_G = Bitboard(0x0101'0101'0101'0101) << 6, BB_FILE_H = Bitboard(0x0101'0101'0101'0101) << 7;
    ...
    const Bitboard BB_RANKS[] = {
        ...
        Bitboard(0xff) << (8 * 7),
                   ...
                   BB_RANK_1 = Bitboard(0xff) << (8 * 0), BB_RANK_2 = Bitboard(0xff) << (8 * 1), BB_RANK_3 = Bitboard(0xff) << (8 * 2), BB_RANK_4 = Bitboard(0xff) << (8 * 3), BB_RANK_5 = Bitboard(0xff) << (8 * 4), BB_RANK_6 = Bitboard(0xff) << (8 * 5), BB_RANK_7 = Bitboard(0xff) << (8 * 6), BB_RANK_8 = Bitboard(0xff) << (8 * 7);
    ...
    typedef std::variant<Bitboard, std::reference_wrapper<SquareSet>, std::vector<Square>> IntoSquareSet;
